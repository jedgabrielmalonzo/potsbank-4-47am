        ...
        btnSubmit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    int generatedPin = 10090 + random.nextInt(90000); // 4-digit PIN

                    JOptionPane.showMessageDialog(frmSignup, "Your PIN is: " + generatedPin, "PIN Generated", JOptionPane.INFORMATION_MESSAGE);
